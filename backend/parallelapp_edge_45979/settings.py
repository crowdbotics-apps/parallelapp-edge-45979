"""
Django settings for parallelapp_edge_45979 project.
...
ROOT_URLCONF = 'parallelapp_edge_45979.urls'
...
WSGI_APPLICATION = 'parallelapp_edge_45979.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "parallelapp_edge_45979 API",
    "DESCRIPTION": "API documentation for parallelapp_edge_45979 App",
    "VERSION": "v1",
}
